...
- User-select property may not be supported in all browsers
        `}},a11y:{config:{rules:[{id:"label",enabled:!1}]}}}},s={parameters:{docs:{description:{story:"Default radio button with basic interaction."}}},render:e=>d(e),args:{name:"radio-default",value:"radio-default",checked:!1,disabled:!1},play:async({canvasElement:e})=>{const a=h(e).getByRole("radio");await o(a).not.toBeNull(),await o(a).toHaveClass("m-radio"),await o(a).not.toBeChecked(),await o(a).not.toBeDisabled(),await m.click(a),await o(a).toBeChecked()}},l={parameters:{docs:{description:{story:"Radio button group showing checked and unchecked states."}}},render:()=>{const e=document.createElement("div");e.style.cssText="display: flex; flex-direction: column; gap: 10px;",e.classList.add("radio-group");const n=d({name:"radio-checked",value:"radio-checked",checked:!0}),a=d({name:"radio-checked",value:"radio-not-checked",checked:!1});return e.append(n,a),e},play:async({canvasElement:e})=>{const t=h(e).getAllByRole("radio")[0];await o(t).not.toBeNull(),await o(t).toHaveClass("m-radio"),await o(t).toBeChecked(),await o(t).toHaveAttribute("name","radio-checked"),await o(t).toHaveAttribute("value","radio-checked")}},u={parameters:{docs:{description:{story:"Radio button in disabled state preventing interaction."}}},render:()=>{const e=d({name:"radio-disabled",value:"radio-disabled",checked:!0,disabled:!0}),n=d({name:"radio-disabled",value:"radio-disabled",checked:!1,disabled:!0}),a=document.createElement("div");return a.style.cssText="display: flex; flex-direction: column; gap: 10px;",a.append(e,n),a},play:async({canvasElement:e})=>{const a=h(e).getAllByRole("radio");for(const t of a)await o(t).not.toBeNull(),await o(t).toHaveClass("m-radio"),await o(t).toBeDisabled()}},p={parameters:{docs:{description:{story:"Radio button with associated label for better accessibility."}}},render:e=>w({name:e.name??"radio-with-label",value:e.value??"radio-with-label",id:e.id??"radio-with-label-default",disabled:e.disabled??!1},e.text),args:{name:"radio-with-label",value:"radio-with-label",id:"radio-with-label",disabled:!1,text:"Select this option"},play:async({canvasElement:e,args:n})=>{const a=h(e),t=a.getByRole("radio"),i=a.getByText(n.text);await o(t).not.toBeNull(),await o(t).toHaveAttribute("id",n.id),await o(t).toHaveAttribute("name",n.name),await o(t).toHaveAttribute("value",n.value),await o(i).not.toBeNull(),await o(i).toHaveAttribute("for",n.id),await o(i).toHaveTextContent(n.text),await o(t).not.toBeChecked(),await m.click(i),await o(t).toBeChecked()}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
