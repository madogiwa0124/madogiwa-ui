...
- Ensure headings are descriptive and meaningful
        `}}}},h={render:i=>{const s=i.text||"Default Heading",o=i.level,e=i.className||"",a=Math.max(1,Math.min(6,o)).toString(),t=document.createElement(`h${a}`);return t.textContent=s,t.classList.add(`m-h${a}`),e&&t.classList.add(...e.split(" ").filter(r=>r.trim())),t},args:{text:"Default Heading",level:1,className:""},play:async({canvasElement:i,args:s})=>{const o=s.level,e=Math.max(1,Math.min(6,o)),l=s.text||"Default Heading",a=e.toString(),t=i.querySelector(`h${a}`);await n(t).toBeInTheDocument(),await n(t).toHaveClass(`m-h${a}`),await n(t).toHaveTextContent(l),await n(t.tagName.toLowerCase()).toBe(`h${a}`);const r=globalThis.getComputedStyle(t);await n(r.marginTop).toBe("0px"),await n(Number.parseFloat(r.marginBottom)).toBeGreaterThan(0),e<=3?await n(Number.parseInt(r.fontWeight)).toBeGreaterThanOrEqual(700):(await n(Number.parseInt(r.fontWeight)).toBeGreaterThanOrEqual(500),await n(Number.parseInt(r.fontWeight)).toBeLessThan(700))}},c={render:()=>{const i=document.createElement("div");i.style.display="flex",i.style.flexDirection="column",i.style.gap="1.5rem",i.style.padding="1rem";const s=[{level:1,text:"Heading Level 1 - Main Title",description:"Primary page heading, used once per page"},{level:2,text:"Heading Level 2 - Section Title",description:"Major section headings"},{level:3,text:"Heading Level 3 - Subsection",description:"Subsection headings"},{level:4,text:"Heading Level 4 - Minor Heading",description:"Component titles and labels"},{level:5,text:"Heading Level 5 - Small Heading",description:"Small headings and labels"},{level:6,text:"Heading Level 6 - Caption",description:"Smallest headings and captions"}];for(const o of s){const e=document.createElement("div");e.style.display="flex",e.style.flexDirection="column",e.style.gap="0.5rem",e.style.padding="1rem",e.style.border="1px solid #e5e7eb",e.style.borderRadius="0.375rem",e.style.backgroundColor="#f9fafb";const l=o.level.toString(),a=document.createElement(`h${l}`);a.textContent=o.text,a.classList.add(`m-h${l}`);const t=document.createElement("p");t.textContent=o.description,t.style.margin="0",t.style.fontSize="0.875rem",t.style.color="#6b7280",t.style.fontStyle="italic",e.append(a,t),i.append(e)}return i},play:async({canvasElement:i})=>{for(let s=1;s<=6;s++){const o=s.toString(),e=i.querySelector(`h${o}`);await n(e).toBeInTheDocument(),await n(e).toHaveClass(`m-h${o}`),await n(e).toHaveTextContent(`Heading Level ${o}`),await n(e.tagName.toLowerCase()).toBe(`h${o}`);const l=globalThis.getComputedStyle(e),a=Number.parseFloat(l.fontSize);switch(s){case 1:{await n(a).toBeGreaterThan(20);break}case 2:{await n(a).toBeGreaterThan(18);break}case 3:{await n(a).toBeGreaterThan(16);break}case 4:{await n(a).toBeGreaterThan(16);break}default:{await n(a).toBeGreaterThanOrEqual(16);break}}const t=Number.parseInt(l.fontWeight);s<=3?await n(t).toBeGreaterThanOrEqual(700):(await n(t).toBeGreaterThanOrEqual(500),await n(t).toBeLessThan(700))}},parameters:{docs:{description:{story:"Overview of all heading levels showing the visual hierarchy and usage guidelines."}}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  render: args => {
