...
- Provide meaningful link text that describes the destination
        `}}}},o={parameters:{docs:{description:{story:`Default link with basic styling and hover effects.`}}},render:e=>t(e),args:{text:`Link text`,href:`https://example.com`,target:`_self`},play:async({canvasElement:e})=>{let t=i(e).getByRole(`link`);await r(t).not.toBeNull(),await r(t).toHaveClass(`m-link`),await r(t).toHaveTextContent(`Link text`),await r(t).toHaveAttribute(`href`,`https://example.com`)}},s={parameters:{docs:{description:{story:`Link integrated within a paragraph of text, showing contextual usage.`}}},render:()=>{let e=document.createElement(`div`),n=document.createElement(`p`);n.textContent=`This is a `;let r=t({text:`link`,href:`https://example.com`});return n.append(r),n.append(document.createTextNode(` included in this example.`)),e.append(n),e},play:async({canvasElement:e})=>{let t=i(e),n=t.getByText(/This is a.*included in this example/),a=t.getByRole(`link`);await r(n).not.toBeNull(),await r(a).not.toBeNull(),await r(a).toHaveClass(`m-link`),await r(a).toHaveTextContent(`link`),await r(a).toHaveAttribute(`href`,`https://example.com`)}},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...s.parameters?.docs?.source}}},c=[`Default`,`InParagraph`]}))();export{o as Default,s as InParagraph,c as __namedExportsOrder,a as default};