...
- Use container queries when available for better responsive behavior
        `}}}},a={parameters:{docs:{description:{story:`Basic 12-column grid system with configurable gap, column spans, and responsive behavior.`}}},render:e=>{let n=Array.from({length:e.itemCount},(t,n)=>({content:`
      ...
      `,colSize:e.itemColSize}));return t({gap:e.gap,subgrid:e.alignRows,autoFit:e.autoFit,autoFitMin:e.autoFitMin,children:n,...e.columnsLength!==12&&{columnsLength:e.columnsLength}})},args:{columnsLength:12,gap:!0,alignRows:!1,itemCount:8,itemColSize:1,autoFit:!1,autoFitMin:`0`},play:async({args:e})=>{let t=document.querySelector(`.m-columns`);if(await r(t).toBeInTheDocument(),await r(t).toHaveClass(`m-columns`),e.gap||await r(t).toHaveClass(`--no-gap`),e.alignRows&&await r(t).toHaveClass(`--subgrid`),e.columnsLength!==12&&await r(t).toHaveAttribute(`data-columns-length`,String(e.columnsLength)),!t)return;let n=t.querySelectorAll(`& > div`);await r(n).toHaveLength(e.itemCount);for(let t of n)await r(t).toHaveAttribute(`data-col-size`,String(e.itemColSize))}},o={render:e=>{let n={content:`
        ...
        `,colSize:e.itemColSize,subgridRows:3},r={content:`
          <img class="m-card__image" src="/stories/components/Card/320x240.png" alt="Example card image showing 320x240 placeholder">
          <div class="m-card__content">
            <h3 class="m-h3">Image Card</h3>
            <p class="m-p" style="color: var(--color-text-muted)">
        ...
        `,colSize:e.itemColSize,subgridRows:3},i={content:`
          <img class="m-card__image" src="/stories/components/Card/320x240.png" alt="Example card image showing 320x240 placeholder">
          <div class="m-card__content">
            <h3 class="m-h3">Image Card</h3>
            <p class="m-p" style="color: var(--color-text-muted)">
        ...
        `,colSize:e.itemColSize,subgridRows:3},a=t({gap:e.gap,alignRows:e.alignRows,children:[]}),o=[n,i,r],s=[];for(let t=0;t<e.itemCount;t++)s.push(o[t%o.length]);for(let e of s){if(!e)continue;let t=document.createElement(`div`);t.className=`m-card`,t.innerHTML=e.content,t.dataset.colSize=String(e.colSize),e.subgridRows&&(t.dataset.subgridRows=String(e.subgridRows)),a.append(t)}return a},args:{columnsLength:12,gap:!0,alignRows:!0,itemCount:3,itemColSize:4,autoFit:!1},play:async({args:e})=>{let t=document.querySelector(`.m-columns`);if(await r(t).toBeInTheDocument(),await r(t).toHaveClass(`m-columns`),e.alignRows){if(await r(t).toHaveClass(`--align-rows`),!t)return;let e=t.querySelectorAll(`div.m-card`);for(let t of e)await r(t).toHaveAttribute(`data-subgrid-rows`,`3`)}},parameters:{docs:{description:{story:`Demonstrates CSS Subgrid alignment where cards with different content lengths have their footer content/buttons perfectly aligned at the bottom. Toggle subgrid to see the difference.`}}}},a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...o.parameters?.docs?.source}}},s=[`Default`,`AlignmentNestedContentRows`]}))();export{o as AlignmentNestedContentRows,a as Default,s as __namedExportsOrder,i as default};