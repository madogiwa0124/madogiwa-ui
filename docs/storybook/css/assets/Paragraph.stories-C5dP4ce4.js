import{n as e}from"./chunk-DnJy8xQt.js";var t,n=e((()=>{t=(e={})=>{let{text:t=`Paragraph text`}=e,n=document.createElement(`p`);return n.classList.add(`m-p`),t&&(n.textContent=t),n}})),r,i,a,o,s,c,l;e((()=>{n(),{expect:r,within:i}=__STORYBOOK_MODULE_TEST__,a={title:`Components/Paragraph`,tags:[`autodocs`],argTypes:{text:{control:`text`,description:`The text content of the paragraph.`}},parameters:{docs:{description:{component:`
### Overview
