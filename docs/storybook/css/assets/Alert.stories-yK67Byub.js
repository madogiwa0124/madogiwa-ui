const{expect:a,within:l}=__STORYBOOK_MODULE_TEST__,y={title:"Components/Alert",tags:["autodocs"],argTypes:{content:{control:{type:"text"},description:"The message content to display in the alert"},icon:{control:{type:"text"},description:"Icon markup (HTML or SVG) to display"},variant:{control:{type:"select"},options:["default","primary","secondary","tertiary","danger","warning"],description:"Visual style variant of the alert"},autoDismiss:{control:{type:"select"},options:["0s","3s","5s","10s"],description:"Auto dismiss duration (0s means no auto dismiss)"},autoDismissProgress:{control:{type:"boolean"},description:"Show progress bar for auto dismiss"},hasActions:{control:{type:"boolean"},description:"Include action buttons in the alert"}},parameters:{docs:{description:{component:`
### Overview
...
}`,...g.parameters?.docs?.source}}};const f=["Default","AllVariants","WithIcon","WithActions","AutoDismiss","MultipleAlerts"];export{m as AllVariants,v as AutoDismiss,d as Default,g as MultipleAlerts,p as WithActions,u as WithIcon,f as __namedExportsOrder,y as default};
