...
- Consider content hierarchy when nesting containers
        `}}}},r={parameters:{docs:{description:{story:`Basic container with centered layout and responsive max-width constraints.`}}},render:e=>{let t=document.createElement(`div`),n=document.createElement(`div`);return n.classList.add(`m-container`),e.padding&&n.classList.add(`--padding`),e.noCentering&&n.classList.add(`--no-centering`),n.style.backgroundColor=`var(--color-bg-default)`,n.innerHTML=`<p>${e.content}</p>`,t.style.backgroundColor=`var(--color-bg-subtle)`,t.style.padding=`1rem`,t.style.minHeight=`200px`,t.append(n),t},args:{content:`This is content inside the container. Resize the viewport to see responsive behavior and padding changes.`,padding:!1,noCentering:!1},play:async({canvasElement:e,args:n})=>{let r=e.querySelector(`.m-container`);await t(r).toBeInTheDocument(),await t(r).toHaveClass(`m-container`);let i=r.querySelector(`p`);await t(i).toBeInTheDocument(),await t(i).toHaveTextContent(n.content);let a=getComputedStyle(r),o=a.getPropertyValue(`--container-sm-max-width`).trim(),s=a.getPropertyValue(`--container-md-max-width`).trim(),c=a.getPropertyValue(`--container-lg-max-width`).trim(),l=a.getPropertyValue(`--container-xl-max-width`).trim(),u=a.getPropertyValue(`--container-2xl-max-width`).trim();await t(o).toBe(`40rem`),await t(s).toBe(`48rem`),await t(c).toBe(`64rem`),await t(l).toBe(`80rem`),await t(u).toBe(`96rem`)}},i={parameters:{docs:{description:{story:`Demonstrates container behavior across different breakpoints with visual indicators for max-width values.`}}},render:e=>{let t=document.createElement(`div`);t.style.backgroundColor=`var(--color-bg-subtle)`,t.style.padding=`1rem`,t.style.fontFamily=`system-ui, sans-serif`;let n=document.createElement(`h2`);n.textContent=`Container Responsive Breakpoints`,n.style.textAlign=`center`,n.style.marginBottom=`2rem`;for(let{label:n,width:r,bgColor:i,padding:a}of[{label:`Small`,width:`40rem`,bgColor:`var(--color-bg-subtle)`,padding:`0 var(--spacing-2)`},{label:`Medium`,width:`48rem`,bgColor:`var(--color-bg-subtle)`,padding:`0 var(--spacing-3)`},{label:`Large`,width:`64rem`,bgColor:`var(--color-bg-subtle)`,padding:`0 var(--spacing-4)`},{label:`X Large`,width:`80rem`,bgColor:`var(--color-bg-subtle)`,padding:`0 var(--spacing-5)`},{label:`2X Large`,width:`96rem`,bgColor:`var(--color-bg-subtle)`,padding:`0 var(--spacing-6)`}]){let o=document.createElement(`div`);o.style.marginBottom=`2rem`;let s=document.createElement(`h3`);s.textContent=n,s.style.marginBottom=`0.5rem`,s.style.fontSize=`1rem`;let c=document.createElement(`div`);c.classList.add(`m-container`),c.style.backgroundColor=i,c.style.border=`2px dashed var(--color-text-muted)`,c.style.setProperty(`--container-2xl-max-width`,r),c.style.setProperty(`--container-xl-max-width`,r),c.style.setProperty(`--container-lg-max-width`,r),c.style.setProperty(`--container-md-max-width`,r),c.style.setProperty(`--container-sm-max-width`,r),c.style.setProperty(`--container-default-padding`,a),c.style.setProperty(`--container-sm-padding`,a),c.style.setProperty(`--container-md-padding`,a),c.style.setProperty(`--container-lg-padding`,a),c.style.setProperty(`--container-xl-padding`,a),c.style.setProperty(`--container-2xl-padding`,a),e.padding&&c.classList.add(`--padding`),e.noCentering&&c.classList.add(`--no-centering`);let l=document.createElement(`div`);l.innerHTML=`
        <p><strong>Max-width:</strong> ${r}</p>
      ...
      `,c.append(l),o.append(s,c),t.append(o)}return t.prepend(n),t},args:{padding:!1,noCentering:!1},play:async({canvasElement:e})=>{let n=e.querySelectorAll(`.m-container`);await t(n).toHaveLength(5);for(let e of n){await t(e).toHaveClass(`m-container`);let n=getComputedStyle(e),r=n.marginInlineStart,i=n.marginInlineEnd;await t(r).not.toBe(`auto`),await t(i).not.toBe(`auto`)}}},a={parameters:{docs:{description:{story:`Container with realistic nested content structure showing how it works with complex layouts including headers, articles, and grid systems.`}}},render:e=>{let t=document.createElement(`div`),n=document.createElement(`div`);return n.classList.add(`m-container`),e.padding&&n.classList.add(`--padding`),e.noCentering&&n.classList.add(`--no-centering`),n.style.backgroundColor=`var(--color-bg-subtle)`,n.innerHTML=`
    ...
    `,t.style.backgroundColor=`var(--color-bg-default)`,t.style.padding=`1rem`,t.append(n),t},args:{content:`This article content shows how the container constrains width while maintaining readability with responsive padding for complex layouts.`,padding:!1,noCentering:!1},play:async({canvasElement:e})=>{let n=e.querySelector(`.m-container`);await t(n).toBeInTheDocument(),await t(n).toHaveClass(`m-container`);let r=n.querySelector(`header`),i=n.querySelector(`main`),a=n.querySelector(`footer`);await t(r).toBeInTheDocument(),await t(i).toBeInTheDocument(),await t(a).toBeInTheDocument();let o=n.querySelector(`[style*='grid-template-columns']`);await t(o).toBeInTheDocument(),await t(o.querySelectorAll(`div`).length).toBeGreaterThanOrEqual(3);let s=getComputedStyle(n);await t(s.marginInlineStart).not.toBe(`auto`),await t(s.marginInlineEnd).not.toBe(`auto`)}},r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...a.parameters?.docs?.source}}},o=[`Default`,`ResponsiveDemo`,`NestedContent`]}))();export{r as Default,a as NestedContent,i as ResponsiveDemo,o as __namedExportsOrder,n as default};