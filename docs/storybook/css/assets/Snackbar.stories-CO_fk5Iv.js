...
- Position modifiers affect responsive behavior on small screens
        `}}}},d={parameters:{docs:{description:{story:"Default snackbar notification with message and action buttons."}}},render:t=>u(t),args:{message:"This is a snackbar message.",position:"default",transition:!1,id:"default-snackbar"},play:async({canvasElement:t})=>{const e=k(t),a=e.getByText("Show Snackbar");a.click();const n=e.getByRole("alert");await r(a).not.toBeNull(),await r(n).not.toBeNull(),await r(n).toHaveClass("m-snackbar"),await r(n).toBeVisible(),e.getByLabelText("Close snackbar").click(),await r(n).not.toBeVisible()}},m={parameters:{docs:{description:{story:"Snackbar with smooth fade-in/out transition effects."}}},render:()=>u({message:"Notification with smooth transitions.",transition:!0,id:"transition-snackbar"}),play:async({canvasElement:t})=>{const e=k(t);e.getByText("Show Snackbar").click();const n=e.getByRole("alert");await r(n).toHaveClass("m-snackbar"),await r(n).toHaveClass("--transition")}},p={parameters:{docs:{description:{story:"Snackbar positioned at different corners of the screen."}}},render:()=>{const t=document.createElement("div");t.style.cssText="display: flex; flex-direction: column; gap: 10px;";const e=[{position:"default",label:"Bottom Left (default)"},{position:"right-bottom",label:"Bottom Right"},{position:"left-top",label:"Top Left"},{position:"right-top",label:"Top Right"}];for(const[a,{position:n,label:i}]of e.entries()){const c=u({message:`Snackbar at ${i}`,position:n,id:`snackbar-${String(a)}`}),l=c.querySelector("button");l.textContent=`Show ${i}`,t.append(c)}return t},play:async({canvasElement:t})=>{const a=k(t).getAllByText(/Show/);await r(a.length).toBe(4);for(const n of a)await r(n).toHaveAttribute("popovertarget")}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...p.parameters?.docs?.source}}};const g=["Default","WithTransition","Positions"];export{d as Default,p as Positions,m as WithTransition,g as __namedExportsOrder,f as default};
